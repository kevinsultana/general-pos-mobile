...
abstract class _$CloudDatabase extends GeneratedDatabase {
  ...
  late final CloudSyncEventDao cloudSyncEventDao = CloudSyncEventDao(
    this as CloudDatabase,
  );
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [syncEvents, syncCursors];
}
...
class $$SyncEventsTableFilterComposer
    extends Composer<_$CloudDatabase, $SyncEventsTable> {
...
class $$SyncEventsTableTableManager
    extends
        RootTableManager<
          ...
          (
            SyncEvent,
            BaseReferences<_$CloudDatabase, $SyncEventsTable, SyncEvent>,
          ),
          SyncEvent,
          PrefetchHooks Function()
        > {
  $$SyncEventsTableTableManager(_$CloudDatabase db, $SyncEventsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$SyncEventsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$SyncEventsTableCreateCompanionBuilder,
      $$SyncEventsTableUpdateCompanionBuilder,
      (SyncEvent, BaseReferences<_$CloudDatabase, $SyncEventsTable, SyncEvent>),
      SyncEvent,
      PrefetchHooks Function()
    >;
...
class $$SyncCursorsTableFilterComposer
    extends Composer<_$CloudDatabase, $SyncCursorsTable> {
...
class $$SyncCursorsTableTableManager
    extends
        RootTableManager<
          ...
          (
            SyncCursor,
            BaseReferences<_$CloudDatabase, $SyncCursorsTable, SyncCursor>,
          ),
          SyncCursor,
          PrefetchHooks Function()
        > {
  $$SyncCursorsTableTableManager(_$CloudDatabase db, $SyncCursorsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
